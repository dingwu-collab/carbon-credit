...
// import { Coins, CheckCircle2, Clock, Shield, FileText, TrendingUp, LockKeyhole, AlertTriangle } from "lucide-react";
// import { toast } from "sonner";
...
//     type: "loan" | "retire" | null;
//     creditId: string | null;
//     project: string | null;
//   }>({ type: null, creditId: null, project: null });
...
//   // Opens the dialog with specific context
//   const initiateAction = (id: string, project: string, type: "loan" | "retire") => {
//     setActionConfig({ type, creditId: id, project });
//     setIsDialogOpen(true);
//   };

//   // Executed when user clicks "Confirm" in the popup
//   const confirmAction = () => {
//     if (!actionConfig.creditId || !actionConfig.type) return;

//     setCredits((prev) =>
//       prev.map((credit) => {
//         if (credit.id === actionConfig.creditId) {
//           // If Loan: status becomes 'pledged'
//           // If Retire: status becomes 'retired' (we'll treat retired same as pledged for visual locking)
//           return { ...credit, status: actionConfig.type === "loan" ? "pledged" : "retired" };
//         }
//         return credit;
//       })
//     );

//     const message = actionConfig.type === "loan" 
//       ? "Credit Locked for Financing" 
//       : "Credit Permanently Retired";
      
//     const description = actionConfig.type === "loan"
//       ? "Assets have been transferred to the collateral smart contract."
//       : "Assets have been burned on-chain.";
...
//                       }
//                     >
//                       {/* Unified Retired/Pledged display */}
...
//                       variant="outline" 
//                       className="flex-1"
//                       onClick={() => initiateAction(credit.id, credit.project, "loan")}
//                     >
//                       <Shield className="w-3 h-3 mr-1" />
//                       Use for Loan
//                     </Button>
...
//                       variant="outline"
//                       className="flex-1"
//                       onClick={() => initiateAction(credit.id, credit.project, "retire")}
//                     >
//                       <CheckCircle2 className="w-3 h-3 mr-1" />
//                       Retire
//                     </Button>
//                   </>
//                 )}
//                 {/* Disabled states for Consumed/Retired tokens */}
//                 {credit.status === "pledged" && (
//                   <Button size="sm" variant="outline" className="w-full bg-gray-50 text-gray-500" disabled>
//                     <LockKeyhole className="w-3 h-3 mr-1" />
//                     Consumed for Loan Financing
//                   </Button>
//                 )}
...
//               {actionConfig.type === "loan" ? (
//                 <>
//                   <LockKeyhole className="w-5 h-5 text-blue-600" />
//                   Confirm Loan Financing
//                 </>
//               ) : (
//                 <>
...
//               {actionConfig.type === "loan" ? (
//                 <span>
//                   You are about to use <strong>{actionConfig.project}</strong> as collateral for a loan.
//                   <br /><br />
//                   This asset will be <strong>locked</strong> and marked as "Retired" in the public registry to prevent double-spending. You cannot trade this asset while the loan is active.
//                 </span>
//               ) : (
//                  <span>
//                   You are about to permanently retire <strong>{actionConfig.project}</strong>.
//                   <br /><br />
//                   This action <strong>cannot be undone</strong>. The token will be burned on the blockchain and removed from circulation.
//                 </span>
//               )}
//             </DialogDescription>
//           </DialogHeader>
...
//             </Button>
//             <Button 
//               className={actionConfig.type === "loan" ? "bg-blue-600 hover:bg-blue-700" : "bg-red-600 hover:bg-red-700"}
//               onClick={confirmAction}
//             >
//               {actionConfig.type === "loan" ? "Confirm & Lock" : "Burn & Retire"}
//             </Button>
//           </DialogFooter>
//         </DialogContent>
//       </Dialog>
