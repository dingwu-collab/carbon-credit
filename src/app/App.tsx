...
// import { LayoutDashboard, Coins, TrendingUp, Award, DollarSign, Shield, Menu, X, Info, Bell, Search, Loader } from "lucide-react";
...
//         <Tabs defaultValue="UserDashboard" className="space-y-6">
//           {/* Desktop Navigation */}
...
//           {/* <TabsContent value = "TokenShowcase">
//             <TokenShowcase />
//           </TabsContent> */}
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block flex-1 max-w-md mx-8"> 
              <div className="relative w-full">
                <Search className="absolute left-2.5 top-2.5 h-4 w-4 text-slate-400" />
                <Input placeholder="Search..." className="pl-9 bg-slate-50 border-slate-200 focus-visible:ring-emerald-500"/>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex flex-col items-end mr-2">
                <span className="text-xs text-slate-500 font-medium">Portfolio Balance</span>
                <span className="text-sm font-bold font-mono text-emerald-600">$42,950.00</span>
              </div>
              <div className="relative">
                <Button variant="ghost" size="icon" className="relative" onClick={() => setIsNotificationOpen(!isNotificationOpen)}>
                  <Bell className="h-5 w-5 text-slate-500" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white border rounded-lg p-2">
               {/* Mobile menu items... ensure onClick calls setActiveTab and setMobileMenuOpen(false) */}
            </div>
          )}

          {/* Tab Content */}
          <TabsContent value="UserDashboard">
            {/* 3. Pass the navigation function down */}
