  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-gray-600">Carbon Credits to Retire</label>
                <span className="text-sm font-medium">{pledgedCredits} tonnes</span>
              </div>
              <Slider
                value={[pledgedCredits]}
          ...
          <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              {pledgedCredits > 0 && (
                <div className="flex justify-between items-center pb-3 border-b">
                  <span className="text-sm text-gray-600">Green Offset Discount</span>
                  <span className="text-green-600">-{collateralDiscount.toFixed(2)}%</span>
                </div>
              )}
      ...
      <AlertDialog open={!!selectedCredit} onOpenChange={() => setSelectedCredit(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Retire Credits Permanently?</AlertDialogTitle>
            <AlertDialogDescription>
